        ...
        return (
            <div>
                <div className="container my-3 py-3">
                    <br /><br />
                    <h1 className="display-6 fw-bold mb-5 text-center">Detail Transaction</h1>
                    ...
                    <NavLink to="/transaksi"><button className='btn btn-sm btn-dark' id="blue">Back</button></NavLink>
                    <NavLink to={`/invoice/${this.state.detail_transaksi.id_transaksi}`} target="_blank" ><button className='btn btn-sm btn-dark ms-1' id="brown">Print</button></NavLink>
                    <br></br>
                </div>
            </div>
        );
